...
const Footer = () => {
    ...
    return (
        <footer className="bottom-0 left-0 right-0 border-b-2 md:border-b-0 md:bg-[#242933] z-50">
            <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                        ...
                        return (
                            <div key={index} className="md:text-white">
                                ...
                                >
                                    ...
                                    {isOpen ? (<FaMinus className="mr-2 block md:hidden" />) : <FaPlus className="mr-2 block md:hidden" />}
                                </div>
                    ...
                    <div className="text-white md:text-footerBlack flex flex-col items-center md:items-end h-full">
                        ...
                        <div className=" md:text-[#BDBFC2] text-[#808080] text-md md:mt-24 flex items-center gap-2 order-1 md:order-2">
                            <AiOutlineGlobal className="text-3xl text-[#808080] md:text-[#808080]"/> Global / English
                        </div>
                    </div>
                </div>
